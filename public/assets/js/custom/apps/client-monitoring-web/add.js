...
var KTUsersAddUser = (function () {
    ...
    const form = modalElement.querySelector("#kt_modal_add_client_form");
    const modal = new bootstrap.Modal(modalElement);

    const submitButton = modalElement.querySelector(
        '[data-kt-clientmonitoring-modal-action="submit"]'
    );
    ...
    if (submitButton) {
        submitButton.addEventListener("click", function (event) {
            ...
            const handleFormSubmit = function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "/monitoringweb/client/store", // Update this URL to your actual route
                    data: $(form).serialize(),
                    headers: {
