...
class UptimeBadge extends Component
{
    ...
    {
        return view('livewire.uptime-badge');
    }

    private function getCustomerSiteMonitoringLogs(ClientWebsiteMonitoring $customerSite)
    {
    ...
    private function getUptimeBadgeBgColor(ClientWebsiteMonitoring $customerSite, MonitoringLog $monitoringLog): string
    {
