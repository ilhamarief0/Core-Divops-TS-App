                      ...
                      <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_client_scroll"
                          ...
                          <div class="fv-row mb-7">
                              ...
                              <input type="text" class="form-control form-control-solid"
                                  placeholder="Masukan Nama Client Anda" id="nameadd" name="name" />
                              <!--end::Input-->
                          </div>
                          <!--end::Input group-->
                          <!--begin::Input group-->
                          ...
                          <div class="fv-row mb-7">
                              ...
                              <!--begin::Input-->
                              <input type="text" class="form-control form-control-solid"
                                  placeholder="Masukan Bot Token Client Anda" name="bot_token" />
                              <!--end::Input-->
                          </div>
                          <!--end::Input group-->
                          <!--begin::Input group-->
                          <div class="fv-row mb-7">
                              ...
                              <!--begin::Input-->
                              <input type="text" class="form-control form-control-solid"
                                  placeholder="Masukan Chat ID Clien Anda" name="chat_id" />
                              <!--end::Input-->
                          </div>
                          <!--end::Input group-->
                      </div>
